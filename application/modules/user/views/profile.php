    ...
    <div class="profile-info col-md-3">
        ...
        <div class="profile-navigation">
            <ul class="user-info">
                ...
                <li><a href="change">
                        <button type="button" class="btn btn-default">Редактировать Профиль</button>
                    </a></li>
            </ul>

            <ul class="navigation">
                <li><a href="<?= BASE_URL . "meme/meme/create" ?>">
                        <button type="button" class="btn btn-default">Создать Мем</button>
                    </a></li>
                <li><a href="<?= BASE_URL . "news/index/index" ?>">
                        <button type="button" class="btn btn-default">Новости</button>
                    </a></li>
                <li><a href="<?= BASE_URL . "subscriptions/subscriptions/printsubscriptions" ?>">
                        <button type="button" class="btn btn-default">Подписки</button>
                    </a></li>
            </ul>
        </div>
    </div>
